...
This directory is reserved for optional C or assembly adapters used by the desktop application. Vel v0.3.3 does not yet expose `extern` declarations or module imports, so files placed here are not linked automatically.
